...
Route::group(['namespace' => 'Admin'],function ()
{
    ...
    Route::get('checktool/descrtiption','CheckToolsController@cheakDescription');
    Route::get('/captcha/{config?}','CaptchasController@Captchas');
    Route::get('/trandlatstypes','ArticleTraslateController@getTypes');
    Route::get('/trandlatsarticles','ArticleTraslateController@getArticles');
    Route::get('/trandlastflink','ArticleTraslateController@getFlinks');
});
