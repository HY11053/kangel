                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-5 basic_info">
                                @if($typeinfos->mid==1)
                                    ...
                                    {{Form::radio('mid', '2',false,array('class'=>"flat-red"))}} 行业资讯
                                    {{Form::radio('mid', '3',false,array('class'=>"flat-red"))}} 问答类型
                                @elseif($typeinfos->mid==2)
                                    {{Form::radio('mid', '0',false,array('class'=>"flat-red"))}} 普通文章
                                    {{Form::radio('mid', '1', true,array('class'=>"flat-red"))}} 品牌类型
                                    {{Form::radio('mid', '2',false,array('class'=>"flat-red",'checked'=>'checked'))}} 行业资讯
                                    {{Form::radio('mid', '3',false,array('class'=>"flat-red"))}} 问答类型
                                    @elseif($typeinfos->mid==3)
                                    {{Form::radio('mid', '0',false,array('class'=>"flat-red"))}} 普通文章
                                    {{Form::radio('mid', '1', true,array('class'=>"flat-red"))}} 品牌类型
                                    {{Form::radio('mid', '2',false,array('class'=>"flat-red"))}} 行业资讯
                                    {{Form::radio('mid', '3',false,array('class'=>"flat-red",'checked'=>'checked'))}} 问答类型
                                 @else
